<h2><a href="https://leetcode.com/problems/powerful-integers/?envType=problem-list-v2&envId=hash-table">970. Powerful Integers</a></h2><h3>Medium</h3><hr><p>Given three integers <code>x</code>, <code>y</code>, and <code>bound</code>, return <em>a list of all the <strong>powerful integers</strong> that have a value less than or equal to</em> <code>bound</code>.</p>
